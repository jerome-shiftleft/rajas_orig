...
function gs_logo_shortcode( $atts ) {
	...
	$gs_l_min_logo = gs_l_get_option( 'gs_l_min_logo', 'gs_l_styling', '5' );
	$gs_l_tab_logo = gs_l_get_option( 'gs_l_tab_logo', 'gs_l_styling', '3' );
	$gs_l_mob_logo = gs_l_get_option( 'gs_l_mob_logo', 'gs_l_styling', '2' );
	$gs_l_ctrl = gs_l_get_option( 'gs_l_ctrl', 'gs_l_control', 'on' );
	$gs_l_ctrl = ($gs_l_ctrl === 'off' ? 0 : 1);
	$gs_l_slide_speed = gs_l_get_option( 'gs_l_slide_speed', 'gs_l_general', '500' );
	$gs_l_inf_loop = gs_l_get_option( 'gs_l_inf_loop', 'gs_l_general', 'on' );
	$gs_l_inf_loop = ($gs_l_inf_loop === 'off' ? false : true);
	$gs_l_move_logo = gs_l_get_option( 'gs_l_move_logo', 'gs_l_styling', '1' );
...
function gs_logo_gutenberg_render( $attributes ) {  
    ...
    $Logo_Group = isset( $attributes['Logo_Group']) ? $attributes['Logo_Group']: '';
    ...
    return '[gs_logo theme="'.$themes.'" speed="'.$Speed.'" title="'.$title.'" orderby="'.$ordersby.'" logo_cat="'. $Logo_Group.'" order="'.$orders.'" posts="'.$numb.'" inf_loop="'.$inf_loop.'"]';
}