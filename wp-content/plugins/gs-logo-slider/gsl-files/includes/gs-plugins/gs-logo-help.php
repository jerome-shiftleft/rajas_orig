...
function gs_logo_help_menu_cb() {
    ...
    <div class="gs-wrap">
    	...
    	<div class="gs_team_wrap gs_team_help" style="width: 845px; float: left; margin-top: 20px; text-align: center;">
			...
			<div class="help-link">
    			<a class="gstm-hlp-btn gstm-btn-1" href="https://www.gsplugins.com/product/gs-logo-slider" target="_blank">Plugin Home</a>
    			<a class="gstm-hlp-btn gstm-btn-2" href="http://logo.gsplugins.com" target="_blank">Live Demo</a>
    			<a class="gstm-hlp-btn gstm-btn-3" href="http://logo.gsplugins.com/documentation" target="_blank">Documentation</a>
    			<a class="gstm-hlp-btn gstm-btn-4" href="http://logo.gsplugins.com/documentation/#GS_Logo_slider8217s_shortcode_usage" target="_blank">Shortcode Usage</a>
    			<a class="gstm-hlp-btn gstm-btn-5" href="https://www.gsplugins.com/support" target="_blank">Support</a>
    			<a class="gstm-hlp-btn gstm-btn-6" href="https://profiles.wordpress.org/samdani/#content-plugins" target="_blank">Free Plugins</a>
            </div>
            <div class="hire-ad">
                <h3>Hire Me</h3>
                <p>Hey, I'm Golam Samdani, a professional WordPress Theme & Plugin Developer with great expertise on Genesis Child Theme development. You can hire me for your projects.<br><br>Email Me : samdani1997@gmail.com <br> Skype : samdani1997 <br> Recent Projects : <a href="https://www.gsplugins.com/recent-works" target="_blank">Works</a></p>
            </div>
