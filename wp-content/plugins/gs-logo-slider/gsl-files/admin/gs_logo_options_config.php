        ...
        $settings_fields = array(
            ...
            'gs_l_styling' => array(
                ...
                array(
                   ...
                   array(
                    'name'  => 'gs_l_min_logo',
                    'label' => __( 'Desktop view Logos', 'gslogo' ),
                    'desc'  => __( 'The minimum number of logos to be shown. Default 5, max 10. <br>(Theme : Slider1)', 'gslogo' ),
                    'type'  => 'number',
                    'min'   => 1,
                    'max'   => 10,
                    'default' => 5
                ...
                array(
                    'name'  => 'gs_l_tab_logo',
                    'label' => __( 'Tablet view Logos', 'gslogo' ),
                    'desc'  => __( 'The minimum number of logos to be shown. Default 3, max 10.<br>(Theme : Slider1)', 'gslogo' ),
                    'type'  => 'number',
                    'min'   => 1,
                    'max'   => 6,
                    'default' => 3
                ...
                array(
                    'name'  => 'gs_l_mob_logo',
                    'label' => __( 'Mobile view Logos', 'gslogo' ),
                    'desc'  => __( 'The minimum number of logos to be shown. Default 2, max 10.<br>(Theme : Slider1)', 'gslogo' ),
                    'type'  => 'number',
                    'min'   => 1,
                    'max'   => 6,
                    'default' => 2
